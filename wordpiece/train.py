...
flags.DEFINE_string('train_dir',   'Attention_WordPiece_LM',     'training directory (models and summaries are saved there periodically)')
...
# model params
flags.DEFINE_integer('rnn_size',        800,                            'size of LSTM internal state')
flags.DEFINE_integer('highway_layers',  2,                              'number of highway layers')
flags.DEFINE_integer('char_embed_size', 16,                             'dimensionality of character embeddings')
flags.DEFINE_string ('kernels',         '[1,2,3,4,5,6,7]',              'CNN kernel widths')
flags.DEFINE_string ('kernel_features', '[50,100,100,150,100,100,100]', 'number of features in the CNN kernel')
...
flags.DEFINE_integer('batch_size',          16,   'number of sequences to train on in parallel')
flags.DEFINE_integer('max_epochs',          25,   'number of full passes through the training data')
flags.DEFINE_float  ('max_grad_norm',       5.0,  'normalize gradients at')
flags.DEFINE_integer('max_word_length',     32,   'maximum word length')
